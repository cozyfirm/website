...
@section('c-breadcrumbs')
    <a href="#"> <i class="fas fa-home"></i> <p>{{ __('Dashboard') }}</p> </a> / <a href="{{ route('system.projects.index') }}">{{ __('Projekti') }}</a>
@endsection
@section('c-buttons')
    <a href="{{ route('system.projects.index') }}">
        <button class="pm-btn btn btn-dark"> <i class="fas fa-star"></i> </button>
    </a>
    <a href="{{ route('system.projects.create') }}">
            ...
            @foreach($singlePages as $page)
                <tr>
                    ...
                    <td class="text-center">
                        <a href="{{ route('system.projects.preview', ['id' => $page->id ]) }}" title="{{ __('Više informacija') }}">
